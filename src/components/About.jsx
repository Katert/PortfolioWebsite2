        ...
        <motion.div
          ...
          >
            <p>
              ...
              finished an intensive full-time full-stack developer bootcamp on
              the 24th of April 2020, organized by{" "}
              ...
              with <span className="highlight">Java</span> and front-end
              programming with{" "}
              <span className="highlight">HTML, CSS and JavaScript</span>, while
              also learning <span className="highlight">React</span>. I also
              have knowledge of setting up databases with MongoDB and Node.js.
              <br />
              At the end of the bootcamp, I discovered that web development is
              really what makes me enthusiastic.
              <br />
              <br />I speak fluently <span className="highlight">
                Dutch
              </span>{" "}
              and I'm proficient at speaking and writing{" "}
              <span className="highlight">English</span>.
              <br />
              <br />
              <span className="highlight">
                At the moment, I'm available for any junior full-stack or
                front-end developer job opportunities. Please don't hesitate to
